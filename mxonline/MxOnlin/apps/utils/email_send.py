...
__author__ = 'xuyijie'
__date__ = '2018/2/22 下午5:34'
from random import Random
from users.models import EmailVerifyRecord
from django.core.mail import send_mail
from MxOnlin.settings import EMAIL_FROM
